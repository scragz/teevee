...
- [x] Create `tv.audio.maxpat` with buffer~/poke~/groove~ rig
- [x] Implement delay line with scroll parameter (tapin~/tapout~)
- [x] Implement varispeed playback with zoom parameter (buffer~/index~)
- [x] Add freqshift~ for rotation
- [x] Add yafr2 reverb for smear
...
## 7. Advantages of v7 Architecture
